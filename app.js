...
// Initialization the data from database from Front End
app.get("/initialize-database", async (req, res) => {
  ...
  } // This will run for 50 times
  res.send({ msg: "Initialized database with third party API" });
}); // Now we got all 50 ids on

// API for Get all transactions API - 1
...
// //API for Get month based statistics API - 2
